...
Source1:       http://www.isi.edu/nsnam/ns/doc/%{name}_doc.pdf
...
Ns jest symulatorem dyskretnych zdarzeń kierowanym w stronę badań
sieci. Dobrze wspiera symulację protokołów TCP, routingu oraz
...
podstawie danych CDF (dystrybuanty) wyciągniętych z prawdziwego
śledzenia tcpdump.
